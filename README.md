...
# example run:
How to Run (from project root /Users/impactoinfra/test_case_generation)
...
# Single scenario
python3 src/generate_test_case.py "Single male, full-time employed, no beneficiaries"

# Estimate cost only (no API call)
python3 src/generate_test_case.py -e

# With auto-validation after generation
python3 src/generate_test_case.py -i -v
2. Structural Validation

# Uses default config paths automatically now!
...
Example with your latest file:

# Structural
python3 src/validators/validator.py "output/test_cases/Married male_ part-time employ_20260202_104905.csv"

# Scenario  
python3 src/validators/scenario_validator.py "output/test_cases/Married male_ part-time employ_20260202_104905.csv" "Married male, part-time employed, 2 beneficiaries, no joint partner, no LinCU, no FIP, all PEP/FATCA = No"